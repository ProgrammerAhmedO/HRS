...
urlpatterns = [
    ...
    # path('room-servicesem/<str:pk>/', deleteService, name="room-services"),
    ...
    path('ReportsSplit/', ReportsSplit, name='ReportsSplit'),
    path('Storage_Reports/', Storage_Reports, name='Storage_Reports'),
    path('Booking_Reports/', Booking_Reports, name='Booking_Reports'),
    path('Event_Reports/', Event_Reports, name='Event_Reports'),
    path('Services_Reports/', Services_Reports, name='Services_Reports'),
    path('Payment/', Payment, name='Payment'),
