...
class Room(models.Model):
    ...
    statusStartDate = models.DateField(auto_now_add=True,null=True)
...
class RoomServices(models.Model):
    ...
    def numOfServices(self):
        return RoomServices.objects.filter(curBooking=self).count()
