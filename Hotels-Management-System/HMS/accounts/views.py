...
def add_employee(request):
    ...
    if request.method == 'POST':
        ...
        post['phoneNumber'] = "+20" + post['phoneNumber']
        request.POST = post
...
def Home(request):
    ...
    for room in rooms:
        if request.method == "POST":
            ...
            if role == 'admin' and request.POST.get("hotel").capitalize() == 'Services' or role == 'admin' and request.POST.get("hotel").capitalize() == 'Service' or role == 'admin' and request.POST.get("hotel").capitalize() == 'Food' or role == 'admin' and request.POST.get("hotel").capitalize() == 'Cleaning' or role == 'admin' and request.POST.get("hotel").capitalize() == 'Technical'  or role == 'admin' and request.POST.get("hotel").title() == 'Room Services' or role == 'admin' and request.POST.get("hotel").title() == 'Room Service'  :
                return redirect("room-services")
            if role == 'guest' and request.POST.get("hotel").capitalize() == 'Services' or role == 'guest' and request.POST.get("hotel").capitalize() == 'Service' or role == 'guest' and request.POST.get("hotel").capitalize() == 'Food' or role == 'guest' and request.POST.get("hotel").capitalize() == 'Cleaning' or role == 'guest' and request.POST.get("hotel").capitalize() == 'Technical' or role == 'guest' and request.POST.get("hotel").title() == 'Room Services' or role == 'guest' and request.POST.get("hotel").title() == 'Room Service'  :
                return redirect("current-room-services")
            if request.POST.get("hotel").capitalize() == 'Announcements' or request.POST.get("hotel").capitalize() == 'Announcement':
                return redirect("announcements")
            if request.POST.get("hotel").capitalize() == 'Events' or request.POST.get("hotel").capitalize() == 'Event' or request.POST.get("hotel").capitalize() == 'Music' or request.POST.get("hotel").capitalize() == 'Theater' or request.POST.get("hotel").capitalize() == 'Concert' :
                return redirect("events")
            if request.POST.get("hotel").capitalize() == 'Reports' or request.POST.get("hotel").capitalize() == 'Report' :
                return redirect("ReportsSplit")
            if request.POST.get("hotel").capitalize() == 'Employee' or request.POST.get("hotel").capitalize() == 'Employees' :
                return redirect("employees")
            if request.POST.get("hotel").capitalize() == 'Refunds' or request.POST.get("hotel").capitalize() == 'Refund' :
                return redirect("refunds")
            if request.POST.get("hotel").capitalize() == 'Guest' or request.POST.get("hotel").capitalize() == 'Guests' :
                return redirect("guests")
            if role == 'staff' and (request.POST.get("hotel").capitalize() == 'Task' or request.POST.get("hotel").title() == 'My Task'):
                return redirect("tasks")
            if role == 'staff' or role == 'manager' and (request.POST.get("hotel").capitalize() == 'Storage' ):
                return redirect("storage")
            if role == 'staff' and (request.POST.get("hotel").capitalize() == 'Food' or request.POST.get("hotel").title() == 'Food Menu' or  request.POST.get("hotel").title() == 'Menu'):
            ...
            if (request.POST.get("hotel") != "" and (role == 'guest' or role == 'admin' or role =='manager')):
                    rooms = rooms.filter(
                        hotel__contains=request.POST.get("hotel"))
